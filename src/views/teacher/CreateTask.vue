<template>
  <div>
    <el-row style="margin-left: 10%;">
      <el-col :span="16">
        <div v-if="stepActive===0">
          <el-form :model="taskForm" :rules="rules" ref="taskForm" label-width="120px" class="taskForm">
            <el-form-item label="作业标题" prop="title" style="width: 60%">
            ...
            <el-form-item label="作业课程目标" style="width: 100%">
              <el-transfer :data="transferData" :render-content="renderContent" v-model="ObjectValue">
              </el-transfer>
            </el-form-item>
            <el-form-item style="margin-left: 20%">
              <el-button type="primary" @click="submitForm('taskForm')">下一步</el-button>
              <el-button @click="resetForm('taskForm')">重置</el-button>
            </el-form-item>
          </el-form>
        </div>
        <div v-else>
          <el-card class="box-card" style="height: 480px;width: 68%;margin-left: 10%" body-style="height: 72%">
            ...
            <div style=" right: 0px; bottom: 0px;float: right;margin-top: 25%">
              <el-button @click="dialogClose">完成</el-button>
            </div>
          </el-card>
      ...
      <el-col :span="5">
        <div style="height: 600px;margin-right: 4%;float: right">
          <el-steps direction="vertical" :active="stepActive" finish-status="success">
            <el-step title="步骤 1" icon="el-icon-edit" description="填写作业信息"></el-step>
            <el-step title="步骤 2" icon="el-icon-upload" description="上传附件"></el-step>
          </el-steps>
        </div>
      </el-col>
    </el-row>
