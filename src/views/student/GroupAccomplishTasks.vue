...
<div>
  ...
  <el-divider content-position="center" v-if="isLeader"><h2>需要进一步完善作业吗</h2></el-divider>
  <el-divider content-position="center" v-else><h2>如果需要修改作业，请通知组长喔</h2></el-divider>
    ...
    <el-table
      ...
      >
        <template slot-scope="scope">
          <el-button @click.stop="deleteClick(scope.row)" type="text" size="small" v-if="isLeader">删除作业</el-button>
        </template>
      </el-table-column>
    </el-table>
  </div>
